...
public class DvfsDatas {
	...
	private HashMap<String, Integer> hashT_My;
	...
	public void setHashMapConservative(
			HashMap<String, Integer> hashT_Conservative) {
	...
	public void setHashMapMy(HashMap<String, Integer> hashT_My) {
		this.hashT_My = hashT_My;
	}

	public HashMap<String, Integer> getHashMapMy() {
		return hashT_My;
	}
}
