...
public class PowerVmAllocationPolicyDVFSDedicateNetworkDiskHost extends
	...
	public PowerVmAllocationPolicyDVFSDedicateNetworkDiskHost(
			List<PowerHost> list) {
		super(list);
		hostList = list;
	}
	...
	public PowerHost findNETHostforVm(Vm vm) {
		return hostList.get(hostList.size() - 3);
	}
