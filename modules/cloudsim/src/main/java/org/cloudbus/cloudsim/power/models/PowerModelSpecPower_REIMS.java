...
/**
 * PowerModel for Grid'5000 Reims site Host. https://www.grid5000.fr/mediawiki/index.php/Reims:Hardware
 * 
...
public class PowerModelSpecPower_REIMS extends PowerModelSpecPowerDVFS {
    ...
    public double getPower(double utilization) throws IllegalArgumentException {
        ...
        // System.out.println("Power computation : index current freq = " + index + " / associated value = " + Tab_Power_idle[index] +"/"+
        // Tab_Power_full[index]);
