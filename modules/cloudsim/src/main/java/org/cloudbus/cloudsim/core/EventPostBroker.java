...
/**
 * EventPost Broker class. This class define an event that will be started at the end of a broker. The user can define in his simulation file if a broker has a
 * PostEvent or not.
 * 
 * @param dest
 *            The unique id number of the destination entity
 * @param tag
 *            An user-defined number representing the type of event. A EventPostBroker is schedule directly at the end of its broker.
