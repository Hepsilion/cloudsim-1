 ...
 * requirements.
 */
public class CloudSimExampleDVFS_simple {
    ...
    private static int vmsTotalNumber = 30;
    private static int no_cur_vm = 0;

    private static int cloudletsTotalNumber = 30;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            vmList = createVms(user_id, vmsTotalNumber, 0);
            // submit vm list to the broker
            broker.submitVmList(vmList);
            cloudletList = createCloudletList(user_id, cloudletsTotalNumber, 0);
    ...
    private static PowerDatacenter createDatacenter(String name) throws Exception {
        ...
        govs.put(0, "PowerSave"); // CPU 1 use OnDemand Dvfs mode
