...
public class DVFS_FF_Example {
	...
	public static void main(String[] args) throws IOException {
        for(int i=0; i<SchedulingConstants.NUMBER_OF_CASE; i++) {
        	...
        	String resultFile = SchedulingConstants.dvfs_ff_result_File + "_"+ temp_numCloudlets;
        	String logFile = SchedulingConstants.dvfs_ff_log_File+ "_"+ temp_numCloudlets;
    		try {
    		...
    		try {
    			...
    			datacenter = (PowerDatacenter) SchedulingHelper.createDatacenter("Datacenter", SchedulingDatacenter.class, hostList, SchedulingConstants.dvfs_ff_vmAllocationPolicy, null);
    		...
    		File file = new File(SchedulingConstants.OutputFolder + "/" +SchedulingConstants.dvfs_ff_log_File+"_"+temp_numCloudlets+".txt");
    		if(file.exists())
    			file.delete();
        }
	}
