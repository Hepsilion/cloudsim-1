...
public class DVFS_MU_Example {
	...
	public static void main(String[] args) throws IOException {
        for(int i=0; i<SchedulingConstants.NUMBER_OF_CASE; i++) {
        	...
        	String resultFile = SchedulingConstants.mu_result_File + "_"+ temp_numCloudlets;
        	String logFile = SchedulingConstants.mu_log_File+ "_"+ temp_numCloudlets;
    		try {
    		...
    		try {
    			...
    			datacenter = (PowerDatacenter) SchedulingHelper.createDatacenter("Datacenter", SchedulingDatacenter.class, hostList, SchedulingConstants.mu_vmAllocationPolicy, null);
    		...
    		File file = new File(SchedulingConstants.OutputFolder + "/" +SchedulingConstants.mu_log_File+"_"+temp_numCloudlets+".txt");
    		if(file.exists())
    			file.delete();
        }
	}
